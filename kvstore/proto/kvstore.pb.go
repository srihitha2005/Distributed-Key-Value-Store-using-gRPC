...
type PutRequest struct {
	...
	IsReplica     bool                   `protobuf:"varint,3,opt,name=isReplica,proto3" json:"isReplica,omitempty"` // true when this call is a replication
...
type DeleteRequest struct {
	state         protoimpl.MessageState `protogen:"open.v1"`
	Key           string                 `protobuf:"bytes,1,opt,name=key,proto3" json:"key,omitempty"`
	IsReplica     bool                   `protobuf:"varint,2,opt,name=isReplica,proto3" json:"isReplica,omitempty"` // true when this call is a replication
	unknownFields protoimpl.UnknownFields
	sizeCache     protoimpl.SizeCache
}
...
const file_proto_kvstore_proto_rawDesc = "" +
	...
	"\x04List\x12\x14.kvstore.ListRequest\x1a\x15.kvstore.ListResponseB\x0fZ\rkvstore/protob\x06proto3"
